<%@ Page Title="Trámite Rechazado" Language="C#" MasterPageFile="~/Mailer/Mail.Master" AutoEventWireup="true" CodeBehind="MailBajaSolicitud.aspx.cs" Inherits="SGI.Mailer.MailBajaSolicitud" %>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="upperBodyContent" style="border-collapse: collapse; color: #43404D; font-family: Georgia; font-size: 16px; line-height: 150%; text-align: left; padding-top:10px; vertical-align:top">
                                                    ...
                                                    <h3>Su tr&aacute;mite ha sido dado de baja.</h3> 
