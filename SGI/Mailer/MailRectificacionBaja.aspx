<%@ Page Title="Trámite Observado" Language="C#" MasterPageFile="~/Mailer/Mail.Master" AutoEventWireup="true" CodeBehind="MailRectificacionBaja.aspx.cs" Inherits="SGI.Mailer.MailObservacionSolicitud" %>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="upperBodyContent" style="border-collapse: collapse; color: #43404D; font-family: Georgia; font-size: 16px; line-height: 150%; text-align: left; padding-top:10px; vertical-align:top">
                                                    ...
                                                    <h3>La Baja de su Solicitud ha sido rectificada.</h3> 
