...
{
    public partial class MailCorreccionSolicitud : BasePage
    {
        ...
        public SGI.Model.MailCorreccionSolicitud GetData()
        {

            SGI.Model.MailCorreccionSolicitud pago_pendiente = null;
            ...
            pago_pendiente = new Model.MailCorreccionSolicitud();
