<%@ Page Title="Trámite Observado" Language="C#" MasterPageFile="~/Mailer/Mail.Master" AutoEventWireup="true" CodeBehind="MailObservacionSolicitud.aspx.cs" Inherits="SGI.Mailer.MailObservacionSolicitud" %>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="upperBodyContent" style="border-collapse: collapse; color: #43404D; font-family: Georgia; font-size: 16px; line-height: 150%; text-align: left; padding-top:10px; vertical-align:top">
                                                    ...
                                                    <h3>Su solicitud fue observada.</h3> 
                                                    <h3>Deber&aacute; presentar la documentaci&oacute;n necesaria para subsanar la misma y permitir que siga su curso.</h3>
