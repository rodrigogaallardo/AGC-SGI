<%@ Page Title="Seguimiento de Trámites Por Tipos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SeguimientoTramitesTipos.aspx.cs" Inherits="SGI.Dashboard.SeguimientoTramitesTipos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hgroup class="title">
        <h1>Seguimiento de Trámites Por Tipos</h1>
    </hgroup>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="control-group pleft20 ptop10 pright25">
                            <asp:GridView ID="grdTramites" runat="server" AutoGenerateColumns="false" Visible="true"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="id_tipotramite" HeaderText="Id" ItemStyle-Width="100px" ItemStyle-CssClass="align-center" Visible="false" />
                                    <asp:BoundField DataField="Descripcion" HeaderText="Tipo de Trámite" ItemStyle-Width="100px" ItemStyle-CssClass="align-center" />
                                    <asp:TemplateField HeaderText="Cantidad" ItemStyle-Width="75px" ItemStyle-CssClass="align-center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="DetalleGraf" runat="server" NavigateUrl="#" Text='<%# Eval("Cantidad") %>' OnClick="DetalleGraf_Click"
                                                CommandArgument='<%# Eval("id_tipotramite") + "," + Eval("Descripcion") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
    ...
    <script type="text/javascript">
        ...
        function graphClickEvent(event, array) {
            try {
                ...
                document.getElementById("MainContent_hidIdTipo").value = id_ger;

                var desc = myChart.data.labels[firstPoint._index].split("-")[1];
                document.getElementById("MainContent_hidDescTipo").value = desc;
