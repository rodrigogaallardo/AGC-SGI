<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucSolicitudesAsignadasCalificarTR.ascx.cs" Inherits="SGI.Dashboard.Controls.ucSolicitudesAsignadasCalificarTR" %>
                ...
                <asp:GridView ID="grdSolAsig" runat="server" AutoGenerateColumns="false"
                   ...
                   DataKeyNames="id_tramitetarea,userid"  >
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="calificador" HeaderText="Calificador"  />
...
<script type="text/javascript">
    ...
    function cargar_ph_sol_asig() {
        ...
        var ws_url = "<%: ResolveUrl("~/Dashboard/Dashboard.aspx") %>" + "/getDatos_solicitudes_asignadas_califTR"
