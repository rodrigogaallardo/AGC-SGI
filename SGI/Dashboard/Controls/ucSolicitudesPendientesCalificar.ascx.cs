...
{
    public partial class ucSolicitudesPendientesCalificar : System.Web.UI.UserControl
    {
        ...
        public void CargarDetalle()
        {
            ...
            //int[] tareas_asignar = new int[3] { (int)Constants.ENG_Tareas.SSP_Asignar_Calificador, (int)Constants.ENG_Tareas.SSP_Asignar_Calificador_Gerente_Nuevo, (int)Constants.ENG_Tareas.SSP_Asignar_Calificador_SubGerente_Nuevo };
            int[] tareas_asignar = Dashboard.getTareasAsignarPorUsuario();
