<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucSolicitudesAsignadasCalificar.ascx.cs" Inherits="SGI.Dashboard.Controls.ucSolicitudesAsignadasCalificar" %>
...
<script type="text/javascript">
    ...
    function cargar_ph_sol_asig() {
        ...
        var ws_url = "<%: ResolveUrl("~/Dashboard/Dashboard.aspx") %>" + "/getDatos_solicitudes_asignadas_calif"
