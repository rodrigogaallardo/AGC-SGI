<%@ Page Title="Seguimiento Equipo de Trabajo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonitoreoPorGruposCircuito.aspx.cs"
    Inherits="SGI.Dashboard.MonitoreoPorGruposCircuito" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hgroup class="title">
        <h1>Seguimiento de tramites por circuitos</h1>
    </hgroup>
                ...
                <div class="accordion-heading">
                    <a id="bt_tramite_btnUpDown" data-parent="#collapse-group" href="#collapse_bt_tramite"
                        ...
                        <div class="widget-title">
                            ...
                            <h5>
                                <asp:Label ID="bt_tramite_tituloControl" runat="server" Text="Desempeño de los tramites por grupo de circuito"></asp:Label></h5>
                                            ...
                                            <div class="form-horizontal" style="width: 100%">
                                                <fieldset>
                                                    <div class="control-group">
                                                        <asp:Label ID="lblGruposCircuitosr" runat="server" AssociatedControlID="ddlGruposCircuitos" Text="Grupos de circuitos:" class="control-label"></asp:Label>
                                                        <div class="controls">
                                                            <asp:DropDownList ID="ddlGruposCircuitos" runat="server" Width="300px"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
            ...
            <div class="widget-content">
                <div class="row">
                    <div style="width: 50%; padding-left: 25%;" id="DivCanvas" runat="server">
                        <canvas id="myChart" height="250" width="250" style="display: none"></canvas>
                    </div>
                </div>
                <asp:UpdatePanel runat="server" ID="updResultado">
                    <ContentTemplate>
                        ...
                        <div class="form-horizontal">
                            <asp:GridView ID="grdGruposCircuitos" runat="server" AutoGenerateColumns="false" Visible="true"
                                GridLines="None" CssClass="table table-bordered table-striped table-hover with-check">
                                <Columns>
                                    <asp:BoundField DataField="id_grupo_circuito" HeaderText="Id circuito" ItemStyle-Width="100px" ItemStyle-CssClass="align-center" />
                                    <asp:BoundField DataField="cantidad" HeaderText="Cantidad" ItemStyle-Width="100px" ItemStyle-CssClass="align-center" />
                                </Columns>
                                <EmptyDataTemplate>
                ...
                <asp:UpdatePanel runat="server" ID="updDetalles">
                    <ContentTemplate>
                        <div class="form-horizontal">
                            <fieldset>
                                <div class="control-group">
                                    <asp:Label ID="DetalleCalificador" Style="font-weight: bold; font-size: 16px; color: #555555" runat="server">Supervisor:</asp:Label>
                                    <br />
                                </div>
                                <div class="control-group">
    ...
    <script type="text/javascript">
        ...
        function inicializar_controles() {
            inicializar_fechas();
            $("#<%: ddlGruposCircuitos.ClientID %>").select2({ allowClear: true });
