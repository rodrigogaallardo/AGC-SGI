<%@ Page Title="Seguimiento Equipo de gerencias" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonitoreoGerencias.aspx.cs" Inherits="SGI.Dashboard.MonitoreoGerencias" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="accordion-heading">
                    <a id="bt_tramite_btnUpDown" data-parent="#collapse-group" href="#collapse_bt_tramite"
                        ...
                        <div class="widget-title">
                            ...
                            <h5>
                                <asp:Label ID="bt_tramite_tituloControl" runat="server" Text="Desempeño de las gerencias"></asp:Label></h5>
                                            ...
                                            <div class="form-horizontal" style="width: 100%">
                                                <fieldset>
                                                    <div class="control-group">
                                                        <asp:Label ID="lblGerencias" runat="server" AssociatedControlID="ddlGerencias" Text="Gerencias:" class="control-label"></asp:Label>
                                                        <div class="controls">
                                                            <asp:DropDownList ID="ddlGerencias" runat="server" Width="300px"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
    ...
    <div id="box_resultados" class="accordion-group widget-box" style="margin-top: 0px; margin-bottom: 5px; display: none" runat="server">
        ...
        <div class="accordion-body" id="collapse_tramites">
            <div class="widget-content">
                <div class="row">
                    <div style="width: 50%; padding-left: 25%;" id="DivCanvas" runat="server">
                        <canvas id="myChart" height="250" width="250" style="display:block"></canvas>
                    </div>
                </div>
                        ...
                        <div class="form-horizontal">
                            <asp:GridView ID="grdCalificadores" runat="server" AutoGenerateColumns="false" Visible="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Cantidad de Solicitudes" ItemStyle-Width="75px" ItemStyle-CssClass="align-center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="DetalleGraf" runat="server" NavigateUrl="#" Text='<%# Eval("cantidad") %>' OnClick="DetalleGraf_Click" CommandArgument='<%# Eval("id_gerencia") + "," + Eval("cod_gerencia")%>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
    ...
    <script type="text/javascript">
        ...
        function inicializar_controles() {
            inicializar_fechas();
            $("#<%: ddlGerencias.ClientID %>").select2({ allowClear: true });
        }
        ...
        function mostrarMensaje(texto, titulo) {
            ...
            $.gritter.add({
                ...
                alert("mostrarMensaje error: " + err.message);
            }
        }
        ...
        function graphClickEvent(event, array) {
            try
            {
                fechaDesde = $('#<%=txtFechaDesde.ClientID%>').val();
                fechaHasta = $('#<%=txtFechaHasta.ClientID%>').val();
                var activePoints = myChart.getElementsAtEvent(event);
                var firstPoint = activePoints[0];
                var id_gerencia = btoa(myChart.data.labels[firstPoint._index].split("-")[0]);
                var value = myChart.data.datasets[firstPoint._datasetIndex].data[firstPoint._index];

                var fDesde = btoa(fechaDesde);
                var fHasta = btoa(fechaHasta);

                var sURL = "../Dashboard/MonitoreoGerenciasDetalle.aspx?idg=" + id_gerencia + "&fD=" + fDesde + "&fH=" + fHasta;
