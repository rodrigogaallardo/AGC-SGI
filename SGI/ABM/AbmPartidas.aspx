<%@ Page Language="C#" AutoEventWireup="true" Title="ABM Partidas" MasterPageFile="~/Site.Master" CodeBehind="AbmPartidas.aspx.cs" Inherits="SGI.ABM.AbmPartidas" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="page_content" style="display: none">
            ...
            <asp:Panel ID="pnlBotonDefault" runat="server" DefaultButton="btnBuscar">
                ...
                <asp:UpdatePanel ID="btn_BuscarPartida" style="margin-top: 10px" runat="server">
                    ...
                    <span class="text">Limpiar</span>
                            ...
                            <asp:LinkButton ID="btnSolActivas" runat="server" CssClass="btn btn-success" OnClick="btnSolActivas_Click">
                                            <i class="icon-white icon-search"></i>
                                            <span class="text">Solicitudes Activas</span>
                            </asp:LinkButton>
                        </div>
                                ...
                                <asp:Panel ID="pnlCantidadRegistros" runat="server" Visible="false" CssClass="form-horizontal">
                                    ...
                                    <div class="text-left">
                                        ...
                                        <div style="width: 21%; float: left;">
                                            ...
                                            <div style="float: left" class="text-left">Confirmadas</div>
                                        </div>
                                    </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="10px" ItemStyle-CssClass="text-center" HeaderStyle-ForeColor="#0088cc" HeaderText="Horizontales">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkHorizontales" runat="server" ToolTip="Partidas Horizontales"
                                                    OnClientClick="return popOverHorizontales(this);" data-toggle="focus" data-visible="false" data-placement="right" CommandArgument='<%#Eval("id_ubicacion")%>' title="partidas horizontales">
                                        <i class="icon-share"></i>
                                                ...
                                                <asp:LinkButton ID="btnNuevaPartidaHori" runat="server" ToolTip="Nueva Partida Horizontal" data-toggle="tooltip" CssClass="link-local"
                                                    CommandArgument='<%#Eval("id_ubicacion")%>' OnClick="btnNuevaPartidaHori_Click">
                                                        <i class="icon-plus"></i>
                                                </asp:LinkButton>
                                                <asp:Panel ID="pnlHorizontales" runat="server" Style="display: none; min-width: 50px; padding: 10px;">
                                                    <%--<asp:UpdatePanel ID="updpnlhorpager" runat="server" UpdateMode="Conditional" >
                                            <ContentTemplate>--%>
                                                    <div style="max-height: 300px; overflow: auto; padding-right: 1px">
                                                        <asp:GridView ID="grdResultadosh" runat="server" AutoGenerateColumns="false" GridLines="None"
                                                            ...
                                                            <%-- SelectMethod="grdResultadosh_GetData"  OnCallingDataMethods="grdResultadosh_CallingDataMethods" OnPageIndexChanging="grdResultadosh_PageIndexChanging" AllowPaging="true" PageSize="10" >--%>
                                                            <Columns>
                                                ...
                                                <%-- <asp:LinkButton ID="lnkprueba"  runat="server" CssClass="btn btn-success"  Text="prueba" ></asp:LinkButton>--%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Acción" ItemStyle-CssClass="text-center" HeaderStyle-ForeColor="#0088cc" ItemStyle-Width="70px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnVer" runat="server" ToolTip="Ver" data-toggle="tooltip" CssClass="link-local"
                                                    CommandArgument='<%#Eval("id_ubicacion") + ";" +Eval("id_estado_modif_ubi")%>' OnClick="btnVer_Click">
                                                ...
                                                <asp:LinkButton ID="btnEditar" runat="server" ToolTip="Editar" data-toggle="tooltip" CssClass="link-local"
                                                    CommandArgument='<%#Eval("id_ubicacion") + ";nada;" +Eval("id_estado_modif_ubi")%>' OnClick="btnEditar_Click">
                                                ...
                                                <asp:LinkButton ID="btnEliminar" runat="server" ToolTip="Eliminar" data-toggle="tooltip" CssClass="link-local"
                                                    CommandArgument='<%#Eval("id_ubicacion") + ";baja;" +Eval("id_estado_modif_ubi")%>' OnClick="btnEditar_Click">
        ...
        <div id="boxActivas" class="widget-box" style="display: none">
            <asp:UpdatePanel ID="updatePanelActivas" runat="server" UpdateMode="Conditional">
                <ContentTemplate>

                    <div style="margin-left: 10px; margin-right: 10px;">
                        <asp:Panel ID="panelActivas" runat="server">

                            <asp:Panel ID="pnlCantidadRegistrosActivas" runat="server" Visible="false" CssClass="form-horizontal">
                                <div class="text-left">
                                    <h5 style="width: 100%; float: left">Resultado de solicitudes activas</h5>
                                </div>

                                <div class="text-right">
                                    <span class="badge">Cantidad de registros:
                <asp:Label ID="lblCantidadRegistrosActivas" runat="server" CssClass="badge">0</asp:Label></span>
                                </div>
                            </asp:Panel>

                            <br />
                            <asp:GridView ID="GrdActivas" runat="server" AutoGenerateColumns="false"
                                GridLines="None" CssClass="table table-bordered"
                                SelectMethod="GetActivas">


                                <Columns>
                                    <asp:BoundField DataField="id_solAct" HeaderText="Nro. Solicitud" ItemStyle-CssClass="text-center" ItemStyle-Width="60px" />
                                    <asp:BoundField DataField="Seccion" HeaderText="Seccion" ItemStyle-CssClass="text-center" ItemStyle-Width="20px" />
                                    <asp:BoundField DataField="Manzana" HeaderText="Manzana" ItemStyle-CssClass="text-center" ItemStyle-Width="20px" />
                                    <asp:BoundField DataField="Parcela" HeaderText="Parcela" ItemStyle-CssClass="text-center" ItemStyle-Width="20px" />

                                    <asp:BoundField DataField="direccionAct" HeaderText="Domicilio" />
                                    <asp:BoundField DataField="partidaAct" HeaderText="Nº de Partida" ItemStyle-Width="60px" ItemStyle-CssClass="text-center" />
                                    <asp:BoundField DataField="tipoPartidaAct" HeaderText="Tipo de Partida" ItemStyle-CssClass="text-center" ItemStyle-Width="60px" />

                                    <asp:BoundField DataField="id_tipoSolAct" HeaderText="Tipo de solicitud" ItemStyle-Width="200px" />

                                    <asp:BoundField DataField="obsAct" HeaderText="Observaciones" ItemStyle-Width="60px" />
                                    <asp:BoundField DataField="id_estado_sol" HeaderText="Estado" ItemStyle-Width="80px" />
                                    <asp:TemplateField HeaderText="Acción" ItemStyle-CssClass="text-center" ItemStyle-Width="3px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnEditarActivas" runat="server" ToolTip="Editar" data-toggle="tooltip" CssClass="link-local"
                                                CommandArgument='<%#Eval("id_solAct") + ";" +Eval("id_tipoSolActI")  + ";" +Eval("tipoPartidaAct") + ";" +Eval("direccionAct")%>' OnClick="btnEditarActivas_Click">
                                                <i class="icon-edit"></i>
                                            </asp:LinkButton>
    ...
    <script type="text/javascript">
        ...
        function init_Js_updPnlFiltroBuscar_ubi_especial() {
            $("#<%: ddlbiTipoUbicacion.ClientID %>").select2({
                allowClear: true,
        ...
        function init_Js_updPnlResultadoBuscar() {
            ...
            //$("[id*='MainContent_grdResultados_lnkprueba_']").each(function () {

            //    $(this).popover({
            //        title: 'Horizontales2', content: 'probando 1 2 3', html: 'true', trigger:'focus', placement: 'right', toggle:'popover' ,
            //        template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div><div class="popover-footer"><a href="javascript:void(0);" class="btn btn-info btn-sm">Close</a></div></div>'
            //    });


            //    // Custom jQuery to hide popover on click of the close button
            //    $(document).on("click", ".popover-footer .btn", function () {
            //        $(this).parentsUntil('.popover fade').popover("hide");
            //    });
        ...
        function init_Js_updZonas() {


            $("#<%: ddlZona1.ClientID %>").select2({
                allowClear: true,
                placeholder: "Seleccione zona",
                minimumInputLength: 0
            });
            $("#<%: ddlZona2.ClientID %>").select2({
                allowClear: true,
                placeholder: "Seleccione zona",
                minimumInputLength: 0
            });
            $("#<%: ddlZona3.ClientID %>").select2({
                allowClear: true,
                placeholder: "Seleccione zona",
                minimumInputLength: 0
            });
<%--            $("#<%: ddlDeslinde1.ClientID %>").select2({
                allowClear: true,
                minimumInputLength: 0
            });
            $("#<%: ddlDeslinde2.ClientID %>").select2({
                allowClear: true,
                minimumInputLength: 0
            });
            $("#<%: ddlDeslinde3.ClientID %>").select2({
                allowClear: true,
                minimumInputLength: 0
            });--%>

            $("#<%: ddlBarrio.ClientID %>").select2({
                allowClear: true,
                placeholder: 'Seleccione el barrio',
                minimumInputLength: 0
            });

            $("#<%: ddlComisaria.ClientID %>").select2({
                allowClear: true,
                placeholder: 'Seleccione la comisaría',
                minimumInputLength: 0
            });
        ...
        function validarGuardarUbicacion() {
            ...
            var Nrofinal;
            var Nropuerta;
            var prueba = ($.trim($("#<%: ddlCalle.ClientID %> :selected").text()));
            ...
            if (ret) {
                ocultarBotonesGuardarUbicacion();
            }
        ...
        function inicializar_popover() {
            ...
            //    var id_pnlHorizontales2 = $(this).attr("id").replace("MainContent_grdResultados_lnkprueba_", "MainContent_grdResultados_lnkprueba_");
            //    //var objHorizontales = $("#" + id_pnlHorizontales).html();
            //    //$(this).popover({ title: 'Horizontales', content: objHorizontales, html: 'true' });

            //    $('[rel="popover"]').popover({
            //        title: 'Horizontales2', content: 'probando 1 2 3', html: 'true',
        ...
        function validarBuscar() {
            ...
            if ($("#buscar_ubi_por_especial").css("display") != "none") {
                ...
                var tipoU = $('#<%: ddlbiTipoUbicacion.ClientID %>').val();
