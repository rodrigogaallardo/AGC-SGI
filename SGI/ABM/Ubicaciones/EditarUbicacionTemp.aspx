<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarUbicacionTemp.aspx.cs" Inherits="SGI.ABM.Ubicaciones.EditarUbicacionTemp" %>
                                                ...
                                                <ContentTemplate>
                                                    <asp:GridView ID="grdUbicaciones" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered mtop5" GridLines="None"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="codigo_calle" HeaderText="CodigoCalle"  ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                            ...
                            <ContentTemplate>
                                <div class="form-inline">
                                    ...
                                    <div id="pnlBotonesGuardarUbicacion" class="control-group">
                                        <asp:Button ID="btnGuardarUbicacion" runat="server" CssClass="btn btn-primary" Text="Guardar"
