<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SubdividirUbicacion.aspx.cs" Inherits="SGI.ABM.Ubicaciones.SubdividirUbicacion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="box_datos">
            <div class="col-sm-12 col-md-12">
                <asp:UpdatePanel ID="updDatos" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:HiddenField ID="hid_id_ubi_padre" runat="server" />
                        <asp:HiddenField ID="hid_ids_ubi_sub" runat="server" />
                        ...
                        <asp:Panel ID="pnlDatos" runat="server" CssClass="form-horizontal">
                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-content">
                                    ...
                                    <asp:UpdatePanel ID="updGridParcelaASubdiv" style="margin-top: 10px" runat="server">
                                        <ContentTemplate>
                                            <asp:Panel ID="pnlParcelaASubdiv" runat="server" Visible="true">
                                                <div class="text-left">
                                                    <h5 style="width: 100%; float: left">Ubicación a fraccionar</h5>
                                                </div>
                                                <br />
                                        ...
                                        <i class="imoon imoon-remove fs16" style="margin-right:3px;margin-left:3px;color:#337AB7"></i>
                                                ...
                                                <div class="pull-right" style="margin-bottom: 20px">
                                                    <asp:LinkButton ID="btnAgregarParASub" runat="server" CssClass="btn btn-success" OnClick="btnAgregarParASub_Click">
                            ...
                            <span class="text">Elegir Ubicación</span>
                                    ...
                                    <asp:UpdatePanel ID="updGridParcelasSubdiv" style="margin-top: 10px" runat="server">
                                        <ContentTemplate>
                                            <asp:Panel ID="pnlParcelasSubdiv" runat="server" Visible="true">
                                                <div class="text-left">
                                                    <h5 style="width: 100%; float: left">Fraccionamiento</h5>
                                                </div>
                                                <br />
                                                <asp:GridView ID="grdParcelasSubdiv" runat="server" AutoGenerateColumns="false" Visible="true"
                                                    GridLines="None" CssClass="table table-bordered" SelectMethod="GetResultadosSub" AllowPaging="true">
                                                    <Columns>
                                                        <asp:BoundField DataField="partida" HeaderText="Partida Matriz" ItemStyle-Width="80px" HeaderStyle-ForeColor="#0088cc" ItemStyle-CssClass="text-center" />
                                                        <asp:BoundField DataField="seccion" HeaderText="Seccion" ItemStyle-CssClass="text-center" HeaderStyle-ForeColor="#0088cc" ItemStyle-Width="20px" />
                                                        <asp:BoundField DataField="manzana" HeaderText="Manzana" ItemStyle-CssClass="text-center" HeaderStyle-ForeColor="#0088cc" ItemStyle-Width="20px" />
                                                        ...
                                                        <asp:TemplateField HeaderText="" ItemStyle-CssClass="text-center" HeaderStyle-ForeColor="#0088cc" ItemStyle-Width="70px">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnEditarSub" runat="server" ToolTip="Editar" data-toggle="tooltip" CssClass="link-local"
                                                                    CommandArgument='<%#Eval("id_ubicacion")%>' OnClick="btnEditarSub_Click">                                                    
                                                                    <i class="imoon imoon-pencil2 fs16" style="margin-right:3px;margin-left:3px;color:#337AB7"></i>
                                                                </asp:LinkButton>
                                                                <asp:LinkButton ID="btnEliminarSub" runat="server" ToolTip="Eliminar" data-toggle="tooltip" CssClass="link-local"
                                                                    CommandArgument='<%#Eval("id_ubicacion")%>' OnClick="btnEliminarSub_Click">                                                    
                                                                    <i class="imoon imoon-remove fs16" style="margin-right:3px;margin-left:3px;color:#337AB7"></i>
                                                                </asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                ...
                                                <br />
                                                <div class="pull-right" style="margin-bottom: 20px">
                                                    <asp:LinkButton ID="btnAgregarParsSub" runat="server" CssClass="btn btn-success" OnClick="btnAgregarParsSub_Click">
                                                        <span class="text">Nueva Fracción</span>
                                                    </asp:LinkButton>
                                                </div>
                                                <br />
                                                <br />
                                        ...
                                        <ContentTemplate>
                                            <div class="form-horizontal">
                                                ...
                                                <div id="pnlBotonesGuardar" class="control-groupp">
                                                    <div class="controls">
                                                        <asp:LinkButton ID="btnGuardar" runat="server" CssClass="btn btn-primary" OnClientClick="return validarGuardarNuevaPartida();" OnClick="btnGuardar_Click">
    ...
    <%-- Parcela a Subdividir - Agregar Ubicación --%>
    ...
    <%-- Fin Parcela a Subdividir - Agregar Ubicación --%>

    <%-- Parcelas Subdivididas - Agregar Ubicaciones --%>
    <div id="frmCargarUbicacion" class="modal fade" style="width: auto;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:UpdatePanel ID="updCargarUbicacion" runat="server">
                        <ContentTemplate>
                            <div class="form-inline">
                                <div class="control-group">
                                    <asp:UpdateProgress ID="UpdateProgress3" runat="server" AssociatedUpdatePanelID="updCargarUbicacion">
                                        <ProgressTemplate>
                                            <img src="<%: ResolveUrl("~/Content/img/app/Loading24x24.gif") %>" />
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                ...
                                <asp:Button ID="btnCargarDatosSub" runat="server" OnClick="btnCargarDatosSub_Click" Style="display: none" />
                                <asp:Panel ID="pnlDatosSub" runat="server" CssClass="form-horizontal">
                                    <div class="widget-box">
                                        <div class="widget-title">
                                            <span class="icon"><i class="imoon imoon-user-md"></i></span>
                                            <h5>ABM Partidas</h5>
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-content">
                                            <div class="control-group pleft20 ptop10 pright25">
                                                <asp:UpdatePanel ID="updCalleSub" runat="server">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="grdCalleSub" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered mtop5" GridLines="None"
                                                            OnRowDataBound="grdCalleSub_RowDataBound">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField ItemStyle-Width="60px" ItemStyle-CssClass="text-center">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="btnEliminarCalleSub" runat="server" title='Eliminar' data-toggle="tooltip" OnClick="btnEliminarCalleSub_Click">
                                                ...
                                                <div class="form-inline">
                                                    <div class="control-group text-left inline-block">
                                                        <div id="Req_CalleSub" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                                            Debe ingresar al menos una calle.
                                                        </div>
                                                    </div>
                                                    <div class="control-group pull-right">
                                                        <asp:LinkButton ID="btnAgregarCalleSub" runat="server" CssClass="btn btn-default" OnClick="btnAgregarCalleSub_Click">
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-content">
                                            ...
                                            <div class="control-group pleft20 ptop10 pright25">
                                                ...
                                                <div class="form-inline">
                                                    <div class="control-group text-left inline-block">
                                                        <div id="Req_MixturaSub" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            ...
                                            <div class="control-group pleft20 ptop10 pright25">
                                                <asp:UpdatePanel ID="updDistritos" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <div class="form-inline">
                                                            <div class="control-group text-left inline-block">
                                                                <div id="Req_DistritoSub" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                    ...
                                    <div class="widget-box">
                                        <div class="widget-content">
                                            <asp:UpdatePanel ID="updBotonesGuardarSub" runat="server">
                                                <ContentTemplate>
                                                    <div class="form-horizontal">
                                                        <div class="control-group">
                                                        ...
                                                        <div id="pnlBotonesGuardarSub" class="control-groupp">
                                                            <div class="controls">
                                                                <asp:LinkButton ID="btnGuardarSub" runat="server" CssClass="btn btn-primary" OnClientClick="return validarGuardarNuevaPartidaSub();" OnClick="btnGuardarSub_Click">
                                                            <i class="imoon imoon-save"></i>
                                                            <span class="text">Guardar</span>
                                                                </asp:LinkButton>
                                                                <asp:LinkButton ID="btnCancelarSub" runat="server" CssClass="btn btn-default" OnClick="btnCancelarSub_Click">
                                                            <i class="imoon imoon-blocked"></i>
                                                            <span class="text">Cancelar</span>
                                                                </asp:LinkButton>
                                                            </div>
    ...
    <%-- Fin Parcelas Subdivididas - Agregar Ubicaciones --%>

    <%-- Parcelas Subdivididas - Agregar Calle --%>
    <div id="frmAgregarCalleSub" class="modal fade" style="width: auto;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <div class="modal-body">
                    <asp:UpdatePanel ID="updAgregarCalleSub" runat="server">
                        <ContentTemplate>
                            <asp:Panel ID="pnlagregarcallesub" runat="server" DefaultButton="btnGuardarCalleSub" CssClass="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtNroPuertaSub" runat="server" Width="70px" MaxLength="5"></asp:TextBox>
                                        <div id="Req_txtNroPuertaSub" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el número de puerta.
                                        </div>
                                    </div>
                                </div>
                                <div id="Req_txtNroPuertaSubParametro" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                ...
                <div class="modal-footer">
                    <asp:UpdatePanel ID="updBotonesGuardarCalleSub" runat="server">
                        <ContentTemplate>
                            <div class="form-inline">
                                <div class="control-group">
                                    <asp:UpdateProgress ID="UpdateProgress6" runat="server" AssociatedUpdatePanelID="updBotonesGuardarCalleSub">
                                        <ProgressTemplate>
                                            <img src="<%: ResolveUrl("~/Content/img/app/Loading24x24.gif") %>" />
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </div>
                                <div id="pnlBotonesGuardarCalleSub" class="control-group">
                                    <asp:Button ID="btnGuardarCalleSub" runat="server" CssClass="btn btn-primary" Text="Aceptar"
                                        OnClientClick="return validarGuardarCalleSub();" OnClick="btnGuardarCalleSub_Click" />
                                    <asp:Button ID="btnCancelCalleSub" runat="server" CssClass="btn btn-default" Text="Cancelar"
                                        OnClick="btnCancelCalleSub_Click" />
                                </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
    ...
    <%-- Fin Parcelas Subdivididas - Agregar Calle --%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#frmCargarUbicacion").hide();
            $("#frmAgregarCalleSub").hide();
        ...
        function showfrmAgregarCalleSub() {

            $("#frmAgregarCalleSub").modal("show");
            return false;
        }

        function hidefrmAgregarCalleSub() {

            $("#frmAgregarCalleSub").modal("hide");
            $("#Req_Ubicaciones").hide();
            return false;
        }
    ...
    function validarGuardarNuevaPartidaSub() {
        ...
        $("#Req_CalleSub").hide();
            ...
            //var rowCountdp = $("[id*=grdCalleSub] tr").length;
            //if (rowCountdp < 2) {
            //    $("#Req_CalleSub").css("display", "inline-block");
            //    ret = false;
            //}

            var rowCountdp = $("[id*=grdMixturas] tr").length;
            if (rowCountdp < 2) {
                $("#Req_MixturaSub").css("display", "inline-block");
                ret = false;
            }

            //var rowCountd = $("[id*=grdDistritos] tr").length;
            //if (rowCountd < 2) {
            //    $("#Req_DistritoSub").css("display", "inline-block");
            //    ret = false;
            //}

            if (!ret) {
                $("#Val_PartidaNuevaSub").css("display", "inline-block");
            }
