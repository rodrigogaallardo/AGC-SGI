                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <asp:DropDownList ID="ddlTipoMov" runat="server" Width="150px">
                                    ...
                                    <asp:ListItem Text="Consulta" Value="C" />
                                </asp:DropDownList>
                            </div>
                        </div>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="grdBuscarMovimientos"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="usuario" HeaderText="Nombre de Usuario" ItemStyle-Width="50px"/>
                                <asp:BoundField DataField="FechaIngreso" HeaderText="Fecha de Ingreso" DataFormatString="{0:d}" ItemStyle-Width="15px" />
                                <asp:BoundField DataField="URL" HeaderText="URL" ItemStyle-Width="80 px" />
                                <%--<asp:BoundField DataField="DatosAdicionales" HeaderText="Objeto Modificado" ItemStyle-Width="80 px" />--%>
