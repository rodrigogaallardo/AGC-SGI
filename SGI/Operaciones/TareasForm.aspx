    ...
    <div class="control-group">
           ...
           <div style="width: 250px; display: inline-block;">
               ...
               <ej:DropDownList ID="ddlSFproxima_tarea" runat="server"  Width="200px"
                   DataTextField="nombre_Tarea" DataValueField="id_Tarea" DataGroupByField="id_circuito" ></ej:DropDownList>
    ...
    <div class="control-group">
           ...
           <div style="width: 250px; display: inline-block;">
                   <asp:DropDownList ID="ddlResultado" runat="server" AutoPostBack="false" 
                             DataTextField="nombre_resultado" DataValueField="id_resultado"></asp:DropDownList>
            </div>
