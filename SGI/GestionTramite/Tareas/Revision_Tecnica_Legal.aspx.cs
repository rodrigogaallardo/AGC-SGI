...
{
    public partial class Revision_Tecnica_Legal : System.Web.UI.Page
    {
        #region cargar inicial

        //private Constants.ENG_Tareas tarea_pagina = Constants.ENG_Tareas.SSP_Revision_Tecnica_Legal;
        ...
        private async Task CargarDatosTramite(int id_tramitetarea)
        {
            ...
            SGI_Tarea_Revision_Tecnica_Legal tecnica_legal = Buscar_Tarea(id_tramitetarea);
        ...
        private void Guardar_tarea(int id_tramite_tarea, string observacion, Guid userId)
        {
            ...
            SGI_Tarea_Revision_Tecnica_Legal tecnica_legal = Buscar_Tarea(id_tramite_tarea);

            int id_rev_tec_leg = 0;
            if (tecnica_legal != null)
                id_rev_tec_leg = tecnica_legal.id_rev_tec_leg;

            db.SGI_Tarea_Revision_Tecnica_Legal_Actualizar(id_rev_tec_leg, id_tramite_tarea, observacion, userId);
        ...
        protected void ucResultadoTarea_GuardarClick(object sender, ucResultadoTareaEventsArgs e)
        {
            try
            {
                ...
                using (TransactionScope Tran = new TransactionScope())
                {
                    ...
                    {
                        Tran.Dispose();
                        LogError.Write(ex, "Error en transaccion. revision_tecnica_legal-ucResultadoTarea_GuardarClick");
                        throw ex;
                    }
        ...
        protected void ucResultadoTarea_FinalizarTareaClick(object sender, ucResultadoTareaEventsArgs e)
        {
            ...
            try
            {
                ...
                using (TransactionScope Tran = new TransactionScope())
                {
                    ...
                    {
                        Tran.Dispose();
                        LogError.Write(ex, "Error en transaccion. revision_tecnica_legal-ucResultadoTarea_FinalizarTareaClick");
                        throw ex;
                    }
                }
                db.Dispose();
        ...
        private void Enviar_Mensaje(string mensaje, string titulo)
        {
            ...
            if (string.IsNullOrEmpty(titulo))
                titulo = System.Web.HttpUtility.HtmlEncode("Revisíón Técnica y Legal");
