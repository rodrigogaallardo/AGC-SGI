<%@ Page Title="Tarea: Revision SubGerente" Language="C#" Async="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Revision_SubGerente.aspx.cs" Inherits="SGI.GestionTramite.Tareas.Dictamen.Revision_SubGerente" %>
