<%@ Page Title="Tarea: Revision Gerente" Language="C#" Async="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Revision_Gerente.aspx.cs" Inherits="SGI.GestionTramite.Tareas.Dictamen.Revision_Gerente" %>
