<%@ Page Title="Tarea: Revisión Subgerente" Language="C#" Async="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Revision_SubGerente.aspx.cs" Inherits="SGI.GestionTramite.Tareas.Transferencias.Revision_SubGerente" %>
