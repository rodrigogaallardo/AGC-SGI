<%@ Page Title="Tarea: Asignar Profesional AVH" Language="C#" Async="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Asignar_Profesional.aspx.cs" Inherits="SGI.GestionTramite.Tareas.Transferencias.Dictamen.Asignar_Profesional" %>
        ...
        <div class="widget-content">
            <div style="padding: 20px">
                <div style="width: 100%;">
                    ...
                    <asp:HiddenField ID="hid_id_resultado" runat="server" />
