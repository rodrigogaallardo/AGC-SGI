...
namespace SGI.GestionTramite.Tareas.Transferencias.Dictamen
{
    public partial class Revision_SubGerente : System.Web.UI.Page
    {
        ...
        private async Task CargarDatosTramite(int id_tramitetarea)
        {
            ...
            SGI_Tarea_Dictamen_Revision_SubGerente pvh = Buscar_Tarea(id_tramitetarea);
        ...
        private SGI_Tarea_Dictamen_Revision_SubGerente Buscar_Tarea(int id_tramitetarea)
        {
            SGI_Tarea_Dictamen_Revision_SubGerente pvh =
                (
                    from env_phv in db.SGI_Tarea_Dictamen_Revision_SubGerente
                    where env_phv.id_tramitetarea == id_tramitetarea
                    orderby env_phv.id_Dictamen_Revision_SubGerente descending
                    select env_phv
                ).FirstOrDefault();
        ...
        private void Guardar_tarea(int id_tramite_tarea, string observacion, Guid userId)
        {
            ...
            SGI_Tarea_Dictamen_Revision_SubGerente pvh = Buscar_Tarea(id_tramite_tarea);

            int id_enviar_avh = 0;
            if (pvh != null)
                id_enviar_avh = pvh.id_Dictamen_Revision_SubGerente;

            db.SGI_Tarea_Dictamen_Revision_SubGerente_Actualizar(id_enviar_avh, id_tramite_tarea, observacion, userId);
