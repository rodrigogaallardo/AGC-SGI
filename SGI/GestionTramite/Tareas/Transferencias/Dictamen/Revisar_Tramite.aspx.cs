...
{
    public partial class Revisar_Tramite : System.Web.UI.Page
    {
        ...
        private void CargarDatosTramite(int id_tramitetarea)
        {
            ...
            SGI_Tarea_Dictamen_Revisar_Tramite pvh = Buscar_Tarea(id_tramitetarea);
        ...
        private SGI_Tarea_Dictamen_Revisar_Tramite Buscar_Tarea(int id_tramitetarea)
        {
            SGI_Tarea_Dictamen_Revisar_Tramite pvh =
                (
                    from env_phv in db.SGI_Tarea_Dictamen_Revisar_Tramite
                    where env_phv.id_tramitetarea == id_tramitetarea
                    orderby env_phv.id_Dictamen_Revisar_Tramite descending
                    select env_phv
                ).FirstOrDefault();
        ...
        private void Guardar_tarea(int id_tramite_tarea, string observacion, Guid userId)
        {
            ...
            SGI_Tarea_Dictamen_Revisar_Tramite pvh = Buscar_Tarea(id_tramite_tarea);

            int id_enviar_avh = 0;
            if (pvh != null)
                id_enviar_avh = pvh.id_Dictamen_Revisar_Tramite;

            db.SGI_Tarea_Dictamen_Revisar_Tramite_Actualizar(id_enviar_avh, id_tramite_tarea, observacion, userId);
