<%@ Page Title="Tarea: Revisión DGHyP" Language="C#" Async="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Revision_DGHP.aspx.cs" Inherits="SGI.GestionTramite.Tareas.Transferencias.Revision_DGHP" %>
