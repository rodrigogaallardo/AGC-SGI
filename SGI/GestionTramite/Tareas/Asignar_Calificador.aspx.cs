            ...
            try
            {
                ...
                using (TransactionScope Tran = new TransactionScope())
                {
                    try
                    {
                        ...
                        Engine.ReTomarTarea(id_tramitetarea_nuevo, userid_asignado);
                ...
                try
                {
                    if (e.id_proxima_tarea == (int)Constants.ENG_Tareas.SCP_Calificar ||
                        e.id_proxima_tarea == (int)Constants.ENG_Tareas.SSP_Calificar ||
                        e.id_proxima_tarea == (int)Constants.ENG_Tareas.ESP_Calificar_1 ||
                        e.id_proxima_tarea == (int)Constants.ENG_Tareas.ESP_Calificar_2)
