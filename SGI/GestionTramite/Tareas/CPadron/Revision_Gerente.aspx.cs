...
{
    public partial class Revision_Gerente : BasePage
    {
        ...
        private void CargarDatosTramite(int id_tramitetarea)
        {
            ...
            SGI_Tarea_Revision_Gerente carga = Buscar_Tarea(id_tramitetarea);
            if (carga != null)
            {
        ...
        {
            SGI_Tarea_Revision_Gerente tarea =
                (
        ...
        private void Guardar_tarea(int id_cpadron, int id_tramitetarea, string observacion, Guid userId)
        {
            ...
            SGI_Tarea_Revision_Gerente tarea = Buscar_Tarea(id_tramitetarea);

            int id_tarea = 0;
            if (tarea != null)
                id_tarea = tarea.id_revision_gerente;

            db.SGI_Tarea_Revision_Gerente_Actualizar(id_tarea, id_tramitetarea, observacion, null, null, null, null, userId, false);
