<%@ Page Title="Tarea: Obtener Ticket Liza" Language="C#" Async="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Obtener_Ticket_Liza.aspx.cs" Inherits="SGI.GestionTramite.Tareas.Obtener_Ticket_Liza" %>
...
<%@ Register Src="~/GestionTramite/Controls/ucProcesosLIZAv1.ascx" TagPrefix="uc1" TagName="ucProcesosLIZAv1" %>
        ...
        <div class="widget-content">
            <div style="padding: 20px">
                <div style="width: 100%;">
                    ...
                    <uc1:ucProcesosLIZAv1 runat="server" ID="ucProcesosLIZA" OnFinalizadoEnSADE="ucProcesosLIZA_FinalizadoEnLIZA" />
