...
namespace SGI.GestionTramite.Tareas
{
    public partial class GenerarBoleta : System.Web.UI.Page
    {
        ...
        private void CargarDatosTramite(int id_tramitetarea)
        {
            ...
            ucMediosDePago.LoadData(id_tramitetarea, true);
        ...
        protected void GenerarBoletaUnica_Click(object sender, ucMediosPagos_EventArgs e)
        {
            try
            {
                ucMediosDePago.GenerarBoletaUnica(e.id_tramite_tarea, (int)Constants.GruposDeTramite.HAB);
                ...
                this.db.SSIT_Solicitudes_ActualizarEstado(this.id_solicitud, (int)Constants.Solicitud_Estados.Pendiente_de_pago, userid, string.Empty, sol.telefono);

                FinalizarEntity();
                
                ucCabecera.LoadData(this.id_solicitud);
