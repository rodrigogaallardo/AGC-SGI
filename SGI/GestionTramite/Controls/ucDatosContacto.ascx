        ...
        <%--Datos de Tramite--%>
            <div style="padding-bottom: 30px">
                <asp:Panel ID="pnlDatosTramite" runat="server" Visible="true">
                    ...
                    <div style="display: flex; justify-content: center" runat="server">

                        <%--Codigo de Area--%>
                        <asp:Label ID="lblCodigoArea" runat="server" AssociatedControlID="codigoArea" Text="Cod. Area:" CssClass="control-label"></asp:Label>
                        ...
                        <%--Prefijo--%>
                        <asp:Label ID="lblPrefijo" runat="server" AssociatedControlID="prefijo" Text="Prefijo:" CssClass="control-label" />
                        ...
                        <%--Sufijo--%>
                        <asp:Label ID="lblSufijo" runat="server" AssociatedControlID="sufijo" Text="Sufijo:" CssClass="control-label" />
            ...
            <div style="padding-bottom: 30px">
                <asp:Panel ID="pnlDatosFisicos" runat="server" Visible="true">
                    ...
                    <div style="display: flex; justify-content: center; padding-top: 20px; padding-bottom: 20px" runat="server">

                        <%--Telefono Movil--%>
                        <asp:Label ID="lblTelefonoMovil" runat="server" AssociatedControlID="telefonoMovil" Text="Teléfono Móvil: " CssClass="control-label" />
                        ...
                        <%--Telefono Fijo--%>
                        <asp:Label ID="lblTelefonoFijo" runat="server" AssociatedControlID="telefonoFijo" Text="Teléfono: " CssClass="control-label" />
                        <div class="controls" style="padding-right: 20px; padding-left: 20px">
                            <asp:TextBox ID="telefonoFijo" runat="server" Width="100px" Enabled="false" />
                        </div>

                        <%--Email--%>
                        <asp:Label ID="lblEmail" runat="server" AssociatedControlID="emailFisico" Text="Email: " CssClass="control-label" />
           ...
           <%--Datos de Contacto de Personas Juridicas--%>
            <asp:Panel ID="pnlDatosJuridico" runat="server" Visible="true">
               <strong><asp:Label ID="tituloPanel3" runat="server" Text="Datos de Contacto de Personas Juridicas:" /></strong>
                <div style="display:flex; justify-content: center; padding-top:20px" runat="server">

                    <%--Telefono Movil--%>
                    <asp:Label ID="lblTelJuridico" runat="server" AssociatedControlID="telJuridico" Text="Teléfono Móvil: " CssClass="control-label" />
                    <div class="controls" style="padding-right: 20px; padding-left: 20px">
                        <asp:TextBox ID="telJuridico" runat="server" Width="100px" Enabled="false" />
                    </div>
                    <%--Email--%>
                    <asp:Label ID="lblEmailJuridico" runat="server" AssociatedControlID="emailJuridico" Text="Email: " CssClass="control-label" />
                    <div class="controls" style="padding-left: 50px">
