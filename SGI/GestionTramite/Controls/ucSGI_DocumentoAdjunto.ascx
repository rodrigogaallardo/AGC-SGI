<%@ Control Language="C#" AutoEventWireup="true"
    CodeBehind="ucSGI_DocumentoAdjunto.ascx.cs"
    Inherits="SGI.GestionTramite.Controls.ucSGI_DocumentoAdjunto" %>
    ...
    <div class="accordion-heading">
        <a id="btnUpDown" data-parent="#collapse-group" href="#collapse_doc_adj"
            ...
            <div class="widget-title">
                ...
                <h5>
                    <asp:Label ID="tituloControl" runat="server" Text="Lista de Documentos Adjuntos"></asp:Label></h5>
                ...
                <asp:Panel ID="pnlDocAdj" runat="server" Visible="true">
                    ...
                    <asp:UpdatePanel ID="updPnlDocumentoAdjunto" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:HiddenField ID="hid_val_upload_fileupload_size" runat="server" Value="" />
...
<script type="text/javascript">
    ...
    function tda_validar_detalle_tipo_documento() {
        var es_valido = true;
        debugger;
        if ($("#div_detalle_otro").is(':visible') && $("#div_detalle_otro").parents(':hidden').length == 0 && $("#MainContent_ucSGI_DocumentoAdjunto_txtDetalle").val().length == 0) {
    ...
    function tda_validar_fileupload_size_archivo(arch_size) {
        ...
        if (arch_size > max) { // 1mb
            ...
            var msj = $("#<%: hid_val_upload_fileupload_size.ClientID %>").val();
            $("#<%: val_upload_fileupload_size.ClientID %>").text(msj);
        }
