<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucUbicacion.ascx.cs" Inherits="SGI.GestionTramite.Controls.ucUbicacion" %>
...
<asp:Panel ID="pnlUbicacion" runat="server" Width="900px">
    <div style="padding: 0px 10px 10px 10px; width: auto">
        ...
        <asp:GridView ID="gridubicacion_db" runat="server" AutoGenerateColumns="false" DataKeyNames="id_solicitudubicacion"
