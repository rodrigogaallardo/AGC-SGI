<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab_Ubicaciones.ascx.cs" Inherits="SGI.GestionTramite.Controls.CPadron.Tab_Ubicaciones" %>
<%@ Register Src="~/GestionTramite/Controls/CPadron/BuscarUbicacion.ascx" TagPrefix="uc" TagName="BuscarUbicacion" %>
                        ...
                        <div class="row pleft40 mtop10">
                            ...
                            <div class="control-group span8">
                                ...
                                <asp:GridView ID="grdPlantasHabilitar" runat="server" AutoGenerateColumns="false"
                                    ...
                                    DataKeyNames="id_cpadrontiposector" Enabled="true"  >
                                    <Columns>
...
<script type="text/javascript">
    ...
    function habilitarControlesUbicacion(habilitar) {
        debugger;
        if (habilitar) {
