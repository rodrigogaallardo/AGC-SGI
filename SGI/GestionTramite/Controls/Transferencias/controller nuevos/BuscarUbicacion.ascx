<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BuscarUbicacion.ascx.cs" Inherits="SGI.GestionTramite.Controls.Transferencias.BuscarUbicacion" %>
...
<div id="pnlBuscarUbicacion" style="width: 100%;">
                    ...
                    <div id="tabs-2">
                        ...
                        <asp:Panel ID="pnlDomicilio" runat="server" DefaultButton="btnBuscar2">
                            ...
                            <div class="form-horizontal pright10">
                                ...
                                <div class="row-fluid">
                                    <label class="span2">N&uacute;mero:</label>
                                    <div class="span4">
                                                                                ...
                                                                                <div class="form-inline">
                                                                                    <div class="control-group">
                                                                                        <label class="checkbox">
                                                                                            <asp:CheckBox ID="chkPuerta" runat="server" />
                                                                                            <asp:Label ID="lblnombreCalle" runat="server" Text="<%# Item.Nombre_calle %>"></asp:Label>
                                                                                        </label>
                                                                                        <asp:TextBox ID="txtNroPuerta" runat="server" Text="<%# Item.NroPuerta_ubic %>" Width="65px" CssClass="form-control grid-txtNroPuerta"></asp:TextBox>
                                    ...
                                    <div class="form-inline text-center mtop5">
                                        ...
                                        <div class="form-group">
                                            <asp:Button ID="btnIngresarUbicacion" runat="server" CssClass="btn btn-primary" Text="Agregar Ubicaci&oacute;n"
                                                Width="160px" OnClick="btnIngresarUbicacion_Click" OnClientClick="return validarIngresarUbicacion();" />
                                        </div>
                                        <div class="form-group">
    ...
    <div id="frmConfirmarNoPH" class="modal fade" style="display: none;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle">
                                ...
                                <div class="mtop10">
                                    ...
                                    Si elige SI se procedrá sin la unidad funcional.</label>
                                </div>
                            </td>
                        </tr>
                    </table>
