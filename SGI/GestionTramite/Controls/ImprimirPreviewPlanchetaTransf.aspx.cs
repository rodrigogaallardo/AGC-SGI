...
{
    public partial class ImprimirPreviewPlanchetaTransf : System.Web.UI.Page
    {
        ...
        private void ImprimirCertificado()
        {
            ...
            var q_datos =
                (
                    ...
                    join transf in db.Transf_Solicitudes on tt_tr.id_solicitud equals transf.id_solicitud
                    where tt_tr.id_solicitud == id_solicitud
                    orderby tt.id_tramitetarea descending
                    select new
                    {
                        tt.id_tramitetarea,
                        transf.NroExpedienteSade
                    }
                ).FirstOrDefault();

            //int id_encomienda = q_datos.id_encomienda;
            ...
            byte[] documento = Plancheta.Transf_GenerarPdf(id_solicitud, expediente_actuacion, true);
