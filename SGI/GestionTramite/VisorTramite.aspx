<%@ Page Title="Visualización del trámite" Async="true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VisorTramite.aspx.cs" Inherits="SGI.GestionTramite.VisorTramite" %>
