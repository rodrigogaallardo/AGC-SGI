...
{
    public partial class ExportarElevadoresGeneral : System.Web.UI.Page
    {
        ...
        private void Exportar()
        {
            ...
            ObjectResult<ASRExportarElevadoresGeneral_Result> result = db.ASRExportarElevadoresGeneral(DateTime.Now.Year, DateTime.Now.Year);

            // Ubicacion, Razon_Social, Anio, Estado_Pago, Estado_Aceptacion, Cant_elevadores

            List<ASRExportarElevadoresGeneral_Result> resultados = result.ToList();
            ...
            Response.AddHeader("content-disposition", "inline; filename=ElevadoresGeneral.xls");
