...
{
    public partial class ExportarElevadoresxEmpresaxEstados : System.Web.UI.Page
    {
        ...
        private void Exportar()
        {
            ...
            ObjectResult<ASRExportarElevadoresxEmpresaxEstados_Result> result = db.ASRExportarElevadoresxEmpresaxEstados();

            // Ubicacion, Razon_Social, Anio, Estado_Pago, Estado_Aceptacion, Cant_elevadores

            List<ASRExportarElevadoresxEmpresaxEstados_Result> resultados = result.ToList();
            ...
            Response.AddHeader("content-disposition", "inline; filename=ElevadoresxEmpresaxEstados.xls");
