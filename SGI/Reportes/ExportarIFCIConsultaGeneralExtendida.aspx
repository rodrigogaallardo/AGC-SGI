<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportarIFCIConsultaGeneralExtendida.aspx.cs" Inherits="SGI.Reportes.ExportarIFCIConsultaGeneralExtendida" %>
    ...
    <form id="form1" runat="server">
        <div id="box_datos" class="widget-box" style="display: none">
            <div class="widget-title">
                ...
                <h5>IFCI - Consulta General Extendida</h5>
            </div>
