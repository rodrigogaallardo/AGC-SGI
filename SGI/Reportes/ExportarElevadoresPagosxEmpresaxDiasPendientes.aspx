<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportarElevadoresPagosxEmpresaxDiasPendientes.aspx.cs" Inherits="SGI.Reportes.ExportarElevadoresPagosxEmpresaxDiasPendientes" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="widget-title">
               ...
               <h5>Elevadores Pagos x Empresa x Días Pendiente de Aceptación</h5>
            </div>
        ...
        <asp:GridView ID="grdEmpresas" runat="server" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:BoundField DataField="Cant_dias_pendiente" HeaderText="Cantidad Días Pendiente" ItemStyle-Width="150px" ItemStyle-CssClass="align-center" />
