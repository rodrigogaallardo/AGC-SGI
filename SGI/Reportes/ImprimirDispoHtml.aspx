<%@ Page Title="Notificación de CaratulaImprimirDispoHtml" Language="C#"
    MasterPageFile="~/Reportes/Reporte.Master"
    AutoEventWireup="true" CodeBehind="ImprimirDispoHtml.aspx.cs"
    Inherits="SGI.Reportes.ImprimirDispoHtml" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlObservacion" runat="server">
        <table class="table table-condensed">
            <tr>
                <td style="vertical-align: top; width:90px"><b>Observaciones:</b></td>
                <td>
